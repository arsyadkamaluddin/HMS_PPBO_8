...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 07 Jun 2024 pada 16.58
...
-- Prosedur
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `after_checkout_ops` (IN `cid` VARCHAR(30), IN `cout` DATE, IN `days` INT(20), IN `amt` INT(30), IN `med` VARCHAR(30))  NO SQL BEGIN
...
--
-- Struktur dari tabel `adv_payment`
--
...
--
-- Dumping data untuk tabel `adv_payment`
--
...
--
-- Dumping data untuk tabel `cd_old`
--
...
('12', 'cobaaja', 2147483647, 'solo', '2024-06-07', '2024-06-10', 1),
...
--
-- Struktur dari tabel `cust_details`
--
...
--
-- Dumping data untuk tabel `cust_details`
--
...
--
-- Struktur dari tabel `rent_history`
--
...
--
-- Indeks untuk tabel `adv_payment`
--
ALTER TABLE `adv_payment`
  ADD PRIMARY KEY (`cust_id`);

--
-- Indeks untuk tabel `cd_old`
--
ALTER TABLE `cd_old`
  ADD PRIMARY KEY (`cust_id`),
...
--
-- Indeks untuk tabel `cust_details`
--
...
--
-- Indeks untuk tabel `rent_history`
--
